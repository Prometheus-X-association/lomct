  ...
  return (
    <div className="h-[496px] mt-2 py-4 px-6 flex flex-col gap-2 rounded-2xl bg-white">
      <div className="flex flex-col gap-2 text-base font-bold items-center">
        ...
        <TextMuted variant="m">Thank you for your contribution in editing this resource!</TextMuted>
      </div>
      <div className="h-full flex flex-col items-center justify-center gap-2">
        <img src={chrome.runtime.getURL('popup/edit-info-success.png')} alt="no reviews." />
