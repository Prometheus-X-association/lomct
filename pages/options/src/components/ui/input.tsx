      ...
      <div
        ...
        <input
          ...
          className={cn(
            ...
            disabled && 'text-neutral04 placeholder:text-neutral04',
            className,
          )}
        ...
        {onPasteBtnClick && (
          <Button
            variant="icon"
            size="icon"
            className={cn('icon-button', disabled && 'cursor-not-allowed opacity-[0.24]')}
            onClick={async e => {
              e.preventDefault();
              e.stopPropagation();
